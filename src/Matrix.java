...
public class Matrix {
	...
	/// Creates a 0x0 matrix. (Next, to give this matrix some dimensions, you should
	/// call:
	/// loadARFF
	/// setSize
	/// newColumn, or
							...
							} else if (valueCount > 0) // if it's nominal
							{
								...
								if (!enumMap.containsKey(val)) {
									throw new IllegalArgumentException(
											"Unrecognized enumeration value " + val + " on line: " + lineNum + ".");
								}
	...
	/// Adds one new row to this matrix at the specified location. Returns a
	...
	/// Removes the specified row from this matrix. Returns a reference to the
	/// removed row.
	...
	/// Returns the mean of the elements in the specified column. (Elements with the
	/// value UNKNOWN_VALUE are ignored.)
	...
	/// Returns the minimum element in the specified column. (Elements with the
	/// value UNKNOWN_VALUE are ignored.)
	...
	/// Returns the maximum element in the specifed column. (Elements with the value
	/// UNKNOWN_VALUE are ignored.)
	...
	/// Returns the most common value in the specified column. (Elements with the
	/// value UNKNOWN_VALUE are ignored.)
	...
	/// Copies the specified rectangular portion of that matrix, and puts it in the
	/// specified location in this matrix.
	public void copyBlock(int destRow, int destCol, Matrix that, int rowBegin, int colBegin, int rowCount,
			int colCount) {
	...
	public void changeGene(int x, int y, double value) {
